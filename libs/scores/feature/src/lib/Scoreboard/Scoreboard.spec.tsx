...
const mockGames: ScoreboardProps['games'] = [
  {
    profile: {
...
describe('Scoreboard', () => {
  it('should render list of games if there is a game scheduled', () => {
    render(<Scoreboard games={mockGames} />);
    expect(screen.getByLabelText('list of games')).toBeDefined();
  });

  it('should render no game scheduled if there is 0 game', () => {
    render(<Scoreboard games={[]} />);
    expect(screen.getByText('No games scheduled')).toBeDefined();
  });
});
